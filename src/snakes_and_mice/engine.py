...
def play_game(mouse: Player, snake: Player) -> GameResult:
...
def _finish(players: dict[Side, Player], result: GameResult) -> GameResult:
    """Notify both players that the game ended, then return the result."""
